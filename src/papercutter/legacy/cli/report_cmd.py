...
def report(
    ...
    Examples:
        ...
        papercutter report paper.pdf

        papercutter report paper.pdf --template referee

        papercutter report paper.pdf --template my-template.md
    """
    from papercutter.legacy.intelligence.report import BUILTIN_TEMPLATES, ReportGenerator
