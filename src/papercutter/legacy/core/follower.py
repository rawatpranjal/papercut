...
from papercutter.legacy.core.resolver import ReferenceResolver, ResolvedReference
from papercutter.legacy.fetchers.base import Document
from papercutter.legacy.fetchers.registry import FetcherRegistry, get_registry
