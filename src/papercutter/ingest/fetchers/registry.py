...
def get_registry() -> FetcherRegistry:
    ...
    """
    from papercutter.ingest.fetchers.arxiv import ArxivFetcher
    from papercutter.ingest.fetchers.doi import DOIFetcher
    from papercutter.ingest.fetchers.nber import NBERFetcher
    from papercutter.ingest.fetchers.ssrn import SSRNFetcher
    from papercutter.ingest.fetchers.url import URLFetcher
